    ...
    try:
        ...
        if not user:
            ...
            if symptoms:
                ...
                first_message = f"Hey {user['name']}, it's good to hear from you again. Last time we spoke we chatted about your {symptoms[0]['symptom']}. I'm here to help you track your symptoms post knee operation. On a scale of 1-10 How is your pain at the moment?"
            else:
